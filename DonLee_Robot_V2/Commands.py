...
async def about(bot: DonLee_Robot_V2, msg: Import.Msg):
        button = [[
          Import.Button("👨‍💻𝖣𝖾𝗉𝗅𝗈𝗒", url='https://t.me/efcinema'),
...
async def sub(bot: DonLee_Robot_V2, msg: Import.Msg):
        button = [[     
          Import.Button("🖥️Group", url="https://t.me/efcinema"),
          Import.Button("𝖲𝗎𝗉𝗉𝗈𝗋𝗍🤝", url="https://t.me/efcinema")
          ],[
          Import.Button("📢𝖴𝗉𝖽𝖺𝗍𝖾𝗌", url="https://t.me/efcinema"),
          Import.Button("💿DVD UPDATES 💿", url="https://t.me/dvdnewupdates")
          ],[
          Import.Button("📦My Channels", url="https://t.me/EF_Linkz"),
          Import.Button("𝖨𝗇𝗌𝗍𝖺😁", url="https://www.instagram.com/yaduvind.k")
          ],[
          Import.Button("𝖢𝗅𝗈𝗌𝖾🗑️", callback_data="close")
          ]]                     
        await bot.send_photo(
...
async def admin(bot, msg):
    button = [[  
       Import.Button("𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾➡️", url="t.me/yaduvind")
       ]]
    await msg.reply_text(
